...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-04 13:35`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/efef7ca2-b0a6-4455-9f62-1ca0e0485ac2.git
$ cd efef7ca2-b0a6-4455-9f62-1ca0e0485ac2
```
